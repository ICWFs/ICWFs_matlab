%MAKE_FACTOR Compilation of LSMIN mex-files
...
disp('Compiling lsmin...')
eval(['mex ', COMPILE_OPTIONS, ' lsmin.c', BLAS_PATH, LAPACK_PATH]);
disp('Compiling lsmind...')
eval(['mex ', COMPILE_OPTIONS, ' lsmind.c', BLAS_PATH, LAPACK_PATH]);
